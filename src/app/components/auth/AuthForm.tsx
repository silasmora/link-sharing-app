      ...
      <form action="" className="flex flex-col gap-10 md:w-[476px] md:bg-white md:p-10 md:rounded-lg">
        ...
        <div className="flex flex-col gap-6">
          <div>
            ...
            <div className="relative">
              <input type="email" name="email" id="email" placeholder="e.g. alex@email.com" 
                className="placeholder:text-[#333333]/50 w-full border border-grey rounded-lg pl-11 py-3 mt-1 leading-6 focus:outline-none focus:border-purple focus:shadow-[0px_0px_32px_0px_rgba(99,60,255,0.25)]" />
          ...
          <div>
            ...
            <div className="relative">
              <input type="password" name="password" id="password" placeholder={isLogin? 'Enter your password' : 'At least .8 characters'} 
                className="placeholder:text-[#333333]/50 w-full border border-grey rounded-lg pl-11 py-3 mt-1 leading-6 focus:outline-none focus:border-purple focus:shadow-[0px_0px_32px_0px_rgba(99,60,255,0.25)]" />
          ...
          {!isLogin && (
            <div>
              <label htmlFor="email" className="block text-[#333333] text-[12px] leading-[18px]">{isLogin? 'password' : 'Create password'}</label>
              <div className="relative">
                <input type="confirmPassword" name="confirmPassword" id="confirmPassword" placeholder='At least .8 characters' 
                  className="placeholder:text-[#333333]/50 w-full border border-grey rounded-lg pl-11 py-3 mt-1 leading-6 focus:outline-none focus:border-purple focus:shadow-[0px_0px_32px_0px_rgba(99,60,255,0.25)]" />
                <svg className="absolute left-4 top-[55%] transform -translate-y-1/2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 16 16"><path fill="#737373" d="M13 5h-2V3.5a3 3 0 0 0-6 0V5H3a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1ZM8.5 9.914V11.5a.5.5 0 0 1-1 0V9.914a1.5 1.5 0 1 1 1 0ZM10 5H6V3.5a2 2 0 1 1 4 0V5Z"/></svg>
              </div>
            </div>
